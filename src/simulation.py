...
if __name__ == '__main__':
    ...
    for i in range(10000):
        ...
        print(" {} % of the way there".format(round(i/10000*100,2)))
    print("total average wait time for 50 simulations of fixed controller was {}".format(sum(wait_fixed)/len(wait_fixed)))
    print("total average wait time for 50 simulations of fixed controller was {}".format(sum(wait_fuzzy)/len(wait_fuzzy)))
